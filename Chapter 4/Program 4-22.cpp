// Thisprogram calculates a consultatnt's charges at $50 per hour, for a minimum of 5 hours. The ?: operator adjusts hours to 5 if less than 5 hours were worked.
#include <iostream>
#include <iomanip>
using namespace std;
