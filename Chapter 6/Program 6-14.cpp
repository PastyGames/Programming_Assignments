...
int main() 
{
	...
	cout << cups << " cups equal " << ounces << " ounces.\n";
	return 0;
}
...
void showIntro()
{
	cout << "This program converts measurements in cups to fluid ounces\n";
	cout << "For your reference the formula is:\n";
	cout << "1 cup = 8 fluid ounces\n\n";
}
...
// number of cups as an arguement and returns the* 
// equivalent number of fluid ounces as as double*
//************************************************
